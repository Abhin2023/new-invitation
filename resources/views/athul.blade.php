...
<head>
    ...
    <link rel="canonical" href="https://weddinginvitation.cards/invitation/">
    <link rel="shortcut icon" type="image/x-icon" href="https://weddinginvitation.cards/invitation/favicon.ico">
    <link rel="apple-touch-icon" sizes="192x192" type="image/png" href="https://weddinginvitation.cards/invitation/assets/images/icon-192x192.png">
    <link rel="icon" type="image/x-icon" href="https://weddinginvitation.cards/invitation/favicon.ico">
...
<body data-key="bfb9cfea33ab7ae21a315fbd6f065a815d3e20ff2f007aa2ca" data-url="https://api.ulems.my.id/" style="overflow-y: hidden;">
    ...
    <nav class="navbar bg-dark navbar-expand fixed-bottom rounded-top-4 p-0" id="navbar-menu">
        <ul class="navbar-nav nav-justified w-100 align-items-center">
            ...
            <!--        <span class="d-block" style="font-size: 0.7rem;">Saying</span>-->
            <!--    </a>-->
            <!--</li>-->
        </ul>
    </nav>
    ...
    <main class="bg-dark text-light" data-bs-spy="scroll" data-bs-target="#navbar-menu" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true" tabindex="0">
        ...
        <!-- <div class="container">
            <div class="text-center" data-aos="fade-up" data-aos-duration="2000">
                ...
                <p class="m-0 fw-bold">1 John 3:16-18</p>
            </div>
        </div> -->
        ...
        <section class="dark-section bg-black" id="tanggal">
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <h1 class="font-esthetic py-3" style="font-size: 2rem;">Countdown To weddingl</h1>
            ...
            <div class="container pb-5 pt-4">
                <div class="card-body border rounded-5 shadow p-3">
                    ...
                    <div id="carousel-image-one" data-aos="fade-up" data-aos-duration="1500" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <img src="./assets/images/athul/sample-21.jpg" alt="gambar 1" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="./assets/images/athul/sample-31.jpg" alt="gambar 2" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="./assets/images/athul/sample-41.jpg" alt="gambar 3" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                        </div>
                    ...
                    <div id="carousel-image-two" data-aos="fade-up" data-aos-duration="1500" class="carousel slide mt-4" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <img src="./assets/images/athul/sample-51.jpg" alt="gambar 4" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="./assets/images/athul/sample-61.jpg" alt="gambar 5" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="./assets/images/athul/sample-71.jpg" alt="gambar 6" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                        </div>
        ...
        <section class="dark-section bg-black" id="tanggal">
            ...
            <div class="container">
                <div class="text-center">
                    ...
                    <h1 class="font-esthetic py-3" style="font-size: 2rem;">Countdown To Get Married</h1>
                    <div class="border rounded-pill shadow py-2 px-4 mx-2 mb-4">
                        ...
                        <div class="row justify-content-center" data-time="2024-08-24 00:00:00" id="count-down-2">
                            ...
                            <div class="col-3 p-1">
                                <h2 class="d-inline m-0 p-0 hour" id="hour-2">0</h2><small class="ms-1 me-0 my-0 p-0 d-inline">Hours</small>
                            </div>
                            <div class="col-3 p-1">
                                <h2 class="d-inline m-0 p-0 minute" id="minute-2">0</h2><small class="ms-1 me-0 my-0 p-0 d-inline">Minutes</small>
                            </div>
                            <div class="col-3 p-1">
                                <h2 class="d-inline m-0 p-0 second" id="second-2">0</h2><small class="ms-1 me-0 my-0 p-0 d-inline">Seconds</small>
                            </div>
                        </div>
                    </div>
        ...
        <section class="dark-section bg-black" id="galeri">
            ...
            <div class="container pb-5 pt-4">
                <div class="card-body border rounded-5 shadow p-3">
                    ...
                    <h1 class="font-esthetic text-center py-3" data-aos="fade-down" data-aos-duration="1500" style="font-size: 2rem;">Wedding Gallery</h1>
                    ...
                    <div id="carousel-image-one" data-aos="fade-up" data-aos-duration="1500" class="carousel slide" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <img src="./assets/images/sample-91.jpg" alt="gambar 1" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="./assets/images/sample-51.jpg" alt="gambar 2" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="./assets/images/sample-81.jpg" alt="gambar 3" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                        </div>
                    ...
                    <div id="carousel-image-two" data-aos="fade-up" data-aos-duration="1500" class="carousel slide mt-4" data-bs-ride="carousel">
                        ...
                        <div class="carousel-inner rounded-4">
                            <div class="carousel-item active">
                                <img src="./assets/images/sample-101.jpg" alt="gambar 1" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="./assets/images/sample-21.jpg" alt="gambar 2" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                            <div class="carousel-item">
                                <img src="./assets/images/sample-71.jpg" alt="gambar 3" class="d-block w-100" onclick="util.modal(this)">
                            </div>
                        </div>
    ...
    <footer class="bg-black">
        <div class="container">
            <div class="text-center">
                ...
                <!--            Build with<i class="fa-solid fa-heart mx-1"></i>Town-->
                <!--        </small>-->
                <!--    </div>-->
                <!--    <div class="col-auto">-->
                <!--        <small>-->
                <!--            <i class="fa-brands fa-github me-1"></i><a target="_blank" href="https://automatically.live">Automatically.live</a>-->
                <!--        </small>-->
                <!--        <small>-->
                <!--            <i class="fa-brands fa-youtube me-1"></i><a target="_blank" href="https://youtu.be/RC30bAqA0vk">Explore our products</a>-->
                <!--        </small>-->
                <!--    </div>-->
                <!--</div>-->
            </div>
